      ...
      <main className="flex-1 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-2xl mx-auto">
            <h1 className="font-serif text-4xl text-plum-dark mb-8 text-center">Contact Us</h1>
            
            <div className="bg-cream rounded-lg p-8 mb-8">
              <h2 className="font-serif text-2xl text-plum-dark mb-4">About SK Hand Embroidery</h2>
            ...
            <div className="bg-rose-light rounded-lg p-8 mb-8 text-center">
              <h2 className="font-serif text-2xl text-plum-dark mb-4">Quick Contact</h2>
              <a
              ...
              <p className="mt-4 text-foreground/70">0312 2789939</p>
            </div>

            <div className="bg-cream rounded-lg p-8">
              <h2 className="font-serif text-2xl text-plum-dark mb-6">Send us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-plum text-cream py-4 rounded-full font-semibold hover:bg-plum-dark transition-colors"
                >
                  Send via WhatsApp
                </button>
              </form>
